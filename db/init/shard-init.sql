...
('Pro Rook Collection', 'Professional tournament rooks', 189.99, '/images/pro_rook.jpg', 'available', 1, 1),
('Champion Bishop Set', 'Championship-grade bishops', 159.99, '/images/champion_bishop.jpg', 'available', 1, 2),
('Elite Knight Pair', 'Elite tournament knights', 199.99, '/images/elite_knight.jpg', 'available', 1, 1),
('Crystal Chess Board', 'Premium crystal 8x8 board', 850.00, '/images/crystal_board.jpg', 'available', 2, 2),
('Professional Tournament Board', 'FIDE approved tournament board', 220.00, '/images/professional_board.jpg', 'available', 2, 1),
('Carbon Fiber Board', 'Lightweight carbon fiber design', 480.00, '/images/carbon_board.jpg', 'available', 2, 2),
('Smart Chess Clock', 'Bluetooth enabled smart clock', 125.99, '/images/smart_clock.jpg', 'available', 3, 1),
('Tournament Timer', 'FIDE certified tournament timer', 85.99, '/images/tournament_timer.jpg', 'available', 3, 2),
('Championship Chess Set', 'Complete championship set', 650.00, '/images/championship_set.jpg', 'available', 4, 1),
('Executive Travel Set', 'Luxury portable set', 45.99, '/images/executive_set.jpg', 'available', 4, 2),
('Master Strategy Guide', 'Grandmaster strategy book', 49.99, '/images/master_strategy.jpg', 'available', 5, 1),
('Complete Opening Guide', 'Comprehensive opening reference', 54.99, '/images/opening_guide.jpg', 'available', 5, 2),
('Pro Analysis Software', 'Advanced analysis platform', 179.99, '/images/pro_analysis.jpg', 'available', 6, 1),
('Chess Pro App', 'Professional mobile application', 19.99, '/images/pro_app.jpg', 'available', 6, 2),
('Deluxe Storage Case', 'Premium storage solution', 105.99, '/images/deluxe_storage.jpg', 'available', 7, 1),
('Professional Board Cover', 'Tournament-grade protection', 65.99, '/images/professional_cover.jpg', 'available', 7, 2),
('Artisan Chess Art', 'Handcrafted chess artwork', 225.00, '/images/artisan_art.jpg', 'available', 8, 1),
('Chess Pro Jersey', 'Official pro team jersey', 44.99, '/images/pro_jersey.jpg', 'available', 9, 2),
('Diamond Chess Pendant', 'Luxury diamond pendant', 179.99, '/images/diamond_pendant.jpg', 'available', 10, 1),
('Collector Chess Set', 'Limited edition collectible', 1500.00, '/images/collector_set.jpg', 'available', 11, 2),
('Championship Entry', 'Elite championship entry', 300.00, '/images/championship_entry.jpg', 'available', 12, 1),
('Master Class Package', '20-hour master class', 399.99, '/images/master_class.jpg', 'available', 13, 2),
('Expert Analysis Service', 'Grandmaster analysis', 99.99, '/images/expert_analysis.jpg', 'available', 14, 1),
('Advanced Puzzle Book', '2000 advanced puzzles', 39.99, '/images/advanced_puzzles.jpg', 'available', 15, 2),
('Chess History Collection', 'Complete historical collection', 64.99, '/images/history_collection.jpg', 'available', 16, 1),
('Legend Memorabilia', 'Signed legend items', 599.99, '/images/legend_memorabilia.jpg', 'available', 17, 2),
('Elite Tournament Clock', 'World championship clock', 195.99, '/images/elite_clock.jpg', 'available', 18, 1),
('Luxury Gift Collection', 'Premium gift package', 325.00, '/images/luxury_gift.jpg', 'available', 19, 2);
...
(3, 3, 189.99, 1, 2003, '2024-02-05 10:30:00'),
(4, 4, 159.99, 2, 2004, '2024-02-05 11:45:00'),
(5, 5, 199.99, 1, 2005, '2024-02-05 13:00:00'),
(6, 6, 850.00, 2, 2006, '2024-02-05 14:15:00'),
(7, 7, 220.00, 1, 2007, '2024-02-05 15:30:00'),
(8, 8, 480.00, 2, 2008, '2024-02-05 16:45:00'),
(9, 9, 125.99, 1, 2009, '2024-02-06 08:00:00'),
(10, 10, 85.99, 2, 2010, '2024-02-06 09:15:00'),
(11, 11, 650.00, 1, 2011, '2024-02-06 10:30:00'),
(12, 12, 45.99, 2, 2012, '2024-02-06 11:45:00'),
(13, 13, 49.99, 1, 2013, '2024-02-06 13:00:00'),
(14, 14, 54.99, 2, 2014, '2024-02-06 14:15:00'),
(15, 15, 179.99, 1, 2015, '2024-02-06 15:30:00'),
(16, 16, 19.99, 2, 2016, '2024-02-06 16:45:00'),
(17, 17, 105.99, 1, 2017, '2024-02-07 08:00:00'),
(18, 18, 65.99, 2, 2018, '2024-02-07 09:15:00'),
(19, 19, 225.00, 1, 2019, '2024-02-07 10:30:00'),
(20, 20, 44.99, 2, 2020, '2024-02-07 11:45:00'),
(21, 21, 179.99, 1, 2021, '2024-02-07 13:00:00'),
(22, 22, 1500.00, 2, 2022, '2024-02-07 14:15:00'),
(23, 23, 300.00, 1, 2023, '2024-02-07 15:30:00'),
(24, 24, 399.99, 2, 2024, '2024-02-07 16:45:00'),
(25, 25, 99.99, 1, 2025, '2024-02-08 08:00:00'),
(26, 26, 39.99, 2, 2026, '2024-02-08 09:15:00'),
(27, 27, 64.99, 1, 2027, '2024-02-08 10:30:00'),
(28, 28, 599.99, 2, 2028, '2024-02-08 11:45:00'),
(29, 29, 195.99, 1, 2029, '2024-02-08 13:00:00'),
(30, 30, 325.00, 2, 2030, '2024-02-08 14:15:00');
